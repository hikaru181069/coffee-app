...
function GraphPreview() {
  ...
  return (
    <Link
      to="/graph"
      className="flex h-full items-center gap-8 rounded-2xl border border-surface-2 bg-raised p-8 shadow-elevated transition-colors duration-150 hover:border-line focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
    >
