  ...
  return (
    <li>
      <Link
        ...
        className={`reveal ${isVisible ? "visible" : ""} ${revealDelayClass(index)} block h-full rounded-none border border-surface-2 bg-raised p-4 shadow-elevated transition-colors duration-150 hover:border-line focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 sm:p-5`}
      >
        {origins.length > 0 && (
