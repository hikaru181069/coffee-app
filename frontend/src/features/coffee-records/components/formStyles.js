...
const BASE_CONTROL =
  "w-full rounded-none border bg-surface-1 px-3 py-2 text-sm text-text " +
...
export const primaryButtonClass =
  "inline-flex items-center justify-center gap-2 rounded-none bg-inverse px-4 py-2 " +
...
export const secondaryButtonClass =
  "inline-flex items-center justify-center gap-2 rounded-none border border-line/60 " +
...
export const dangerButtonClass =
  "inline-flex items-center justify-center gap-2 rounded-none bg-danger px-4 py-2 " +
  "text-sm font-semibold text-on-inverse transition-colors duration-150 " +
  "hover:bg-danger/85 focus:outline-none focus-visible:ring-2 focus-visible:ring-danger/50 " +
  "disabled:cursor-not-allowed disabled:opacity-60";

export const cardClass =
  "rounded-none border border-surface-2 bg-raised p-4 shadow-elevated sm:p-5";
